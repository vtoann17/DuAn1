...
const changePage = async (page) => {
    // đảm bảo page không vượt tổng số trang
...
<template>
    <div class="container py-4">
        ...
        <h1 class="mb-4 fw-bold">Quản lý danh mục</h1>
        ...
        <div class="toolbar d-flex align-items-center justify-content-between flex-wrap gap-3">
                ...
                <div class="toolbar-item d-flex align-items-center gap-2">
                    ...
                    <div class="custom-select" tabindex="0" @click="toggleDropdown('perPage')" @blur="closeDropdown('perPage')">
                        ...
                        <div class="custom-options" :class="{ show: dropdownOpen.perPage }">
                            <div class="custom-option" v-for="num in [5,10,20,50]" :key="num"
            ...
            <div class="toolbar-right">
                <input v-model="query.search" type="text" @keyup.enter="search" placeholder="Tìm kiếm danh mục...">
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title fw-bold">{{ isEditing ? 'Chỉnh sửa danh mục' : 'Thêm danh mục mới' }}</h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                ...
                                <input type="file" accept="image/*" id="categoryImage" @change="handleFileUpload" hidden>
                        ...
                        <div class="mb-3">
                            ...
                            <input v-model="form.name" type="text" class="form-control form-control-lg" placeholder="Nhập tên danh mục">
                        </div>
                    </div>
...
thead th:nth-child(1)::before { content: "\f0ae"; color: #2563eb; }  /* # */
thead th:nth-child(2)::before { content: "\f03e"; color: #3b82f6; }  /* ảnh */
thead th:nth-child(3)::before { content: "\f02b"; color: #16a34a; }  /* tags */
thead th:nth-child(4)::before { content: "\f085"; color: #ef4444; }  /* cogs */
...
.toolbar-item label::before {
    content: "\f06e"; /* Font Awesome icon: eye (hiển thị) */
    font-family: "Font Awesome 6 Free";
    font-weight: 900;
    margin-right: 6px;
    font-size: 14px;
...
.toolbar-item:nth-child(2) label::before {
    content: "\f161"; /* Font Awesome icon: sort (sắp xếp) */
    font-family: "Font Awesome 6 Free";
    font-weight: 900;
    margin-right: 6px;
    font-size: 14px;
...
/* Icon bên trái chữ Hiển thị */
.toolbar-item label::before {
    content: "\f06e"; /* Font Awesome icon: eye */
    font-family: "Font Awesome 6 Free";
    font-weight: 900;
    margin-right: 8px;
    font-size: 20px;   /* tăng size */
...
/* Riêng cho label Sắp xếp */
.toolbar-item:nth-child(2) label::before {
    content: "\f161"; /* Font Awesome icon: sort */
    font-family: "Font Awesome 6 Free";
    font-weight: 900;
    margin-right: 8px;
    font-size: 20px;   /* tăng size */
